  ...
  class ElectraGPT {
    ...
    generateImage(args) {
      ...
      return Scratch.fetch(`${api_url}/images/generations`, {
        // This cant be added from the API URL.
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
